...
import javax.persistence.Table;
	...
	private String userInactiveReason;
	
	@Column(name="USER_INACTIVE_DATE_TIME")
	private String userInactiveDateTime;
	...
	public String getUserInactiveReason(){
	 return userInactiveReason;
	}
	
	public void setUserInactiveReason(String userInactiveReason){
	 this.userInactiveReason=userInactiveReason;
	}
	
	public String getUserInactiveDateTime(){
	 return userInactiveDateTime;
	}
	
	public void setUserInactiveDateTime(String userInactiveDateTime){
	 this.userInactiveDateTime=userInactiveDateTime;
	}
