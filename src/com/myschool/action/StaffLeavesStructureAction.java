 ...
 * 
 */
public class StaffLeavesStructureAction extends ActionSupport {
	
	private static final long serialVersionUID = -247538258753105326L;

	private static Logger log = Logger.getLogger(StaffLeavesStructureAction.class);	
