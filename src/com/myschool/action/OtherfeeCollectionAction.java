 ...
 * 
 */
public class OtherfeeCollectionAction extends ActionSupport implements SessionAware {
	
	private static Logger log = Logger.getLogger(OtherfeeCollectionAction.class);	
