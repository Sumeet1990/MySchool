 ...
 * 
 */
public class ConfigurationMenuAction extends ActionSupport implements SessionAware {
	
	private static Logger log = Logger.getLogger(ConfigurationMenuAction.class);
