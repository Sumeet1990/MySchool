...
public class TuitionfeeCollectionAction extends ActionSupport implements SessionAware {
	
	private static final long serialVersionUID = 1L;

	private static Logger log = Logger.getLogger(TuitionfeeCollectionAction.class);	
