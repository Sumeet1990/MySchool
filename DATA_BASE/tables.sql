CREATE TABLE "MYSCHOOL"."USER_DETAILS" (
	...
	"USER_NAME"   			VARCHAR2(18 BYTE) NOT NULL,
...
CREATE TABLE "MYSCHOOL"."USER_ROLE" (
	"USER_ROLE_ID"     			NUMBER(2,0) NOT NULL,
	"USER_ROLE_NAME"   			VARCHAR2(18 BYTE) NOT NULL,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2 (20),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2 (20),
...
CREATE TABLE "MYSCHOOL"."STAFF_ADDRESS" (
	...
	"PERSONAL_CONTACT_NUMBER"	VARCHAR2(60 BYTE) NOT NULL,
...
CREATE TABLE "MYSCHOOL"."SCHOOL_CLASS_SECTION" (
	"SCHOOL_CLASS_SECTION_ID" NUMBER(16,0) NOT NULL,	
	"SCHOOL_CLASS_ID"     		NUMBER(16,0) NOT NULL,	
    ...
    CONSTRAINT "PK_SCHOOL_CLASS_SECTION_ID" PRIMARY KEY ("SCHOOL_CLASS_SECTION_ID"),
...
CREATE TABLE "MYSCHOOL"."CLASS_EXAMS" (
	"CLASS_EXAMS_ID"		VARCHAR2(12 BYTE) NOT NULL,
	"SCHOOL_CLASS_ID"     		NUMBER(16,0) NOT NULL,	
	"EXAMS"				VARCHAR2(300 BYTE),	
	"TOTAL_EXAMS"			NUMBER(2,0) NOT NULL,	
	"CREATED_USER_ID"		VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"		VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2 (20),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2 (20),
	
	CONSTRAINT "PK_CLASS_EXAMS" PRIMARY KEY ("CLASS_EXAMS"),
	CONSTRAINT "FK_SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "MYSCHOOL"."SCHOOL_CLASS" ("SCHOOL_CLASS_ID") ENABLE
)
...
CREATE TABLE "MYSCHOOL"."STUDENT_REPORT" (
	...
	CONSTRAINT "FK_STUDENT_ROLL_NO" FOREIGN KEY ("STUDENT_ROLL_NO") REFERENCES "MYSCHOOL"."STUDENT_DETAILS" ("STUDENT_ROLL_NO") ENABLE,
