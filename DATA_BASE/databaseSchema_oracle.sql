CREATE  OR REPLACE TABLE "STAFF_ADDRESS" (
...
CREATE  OR REPLACE TABLE "STAFF_APPOINTMENT" (
...
CREATE  OR REPLACE TABLE "STAFF_DETAILS" (
...
CREATE  OR REPLACE TABLE "USER_ROLE_AND_ACCESS" (
...
CREATE  OR REPLACE TABLE "USER_DETAILS" (
	...
	"LAST_LOGEDIN_DATE_TIME"	VARCHAR2(12 BYTE) NOT NULL,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2(20 BYTE),
...
CREATE  OR REPLACE TABLE "STAFF_LEAVES" (
...
CREATE  OR REPLACE TABLE "STAFF_ATTENDANCE" (
...
CREATE  OR REPLACE TABLE "CLASS_SECTION" (
...
CREATE  OR REPLACE TABLE "SCHOOL_TIMINGS" (
	...
	"WEEK_DAY"		     		VARCHAR2(9,0) NOT NULL,		
...
CREATE  OR REPLACE TABLE "SCHOOL_SUBJECTS" (
	"SCHOOL_SUBJECT_ID"			NUMBER(16,0) NOT NULL,
	"SUBJECT_CODE"				VARCHAR2(12 BYTE) NOT NULL UNIQUE,	
...
CREATE  OR REPLACE TABLE "CLASS_EXAMS" (
...
CREATE  OR REPLACE TABLE "EXAM_SUBJECT_SCHEDULE" (
...
CREATE  OR REPLACE TABLE "GENERAL_HOLIDAY_LIST" (
...
CREATE  OR REPLACE TABLE "CLASS_HOLIDAY_LIST" (
...
CREATE  OR REPLACE TABLE "GENERAL_EVENTS" (
...
CREATE  OR REPLACE TABLE "CLASS_EVENTS" (    
...
CREATE  OR REPLACE TABLE "STUDENT_ADDRESS" (
...
CREATE  OR REPLACE TABLE "STUDENT_REGISTRATION" (
...
CREATE  OR REPLACE TABLE "STUDENT_CURRENT_DETAILS" (
...
CREATE  OR REPLACE TABLE "STUDENT_REPORT" (
	...
	"SUBJECTS_FAILED"			NUMBER(2,0) NOT NULL DEFAULT 0,
	...
	"TOTAL_LEAVE_DAYS"			NUMBER(3,0) NOT NULL DEFAULT 0,
	"TOTAL_ABSENT_DAYS"			NUMBER(3,0) NOT NULL DEFAULT 0,
...
CREATE  OR REPLACE TABLE "SCHOOL_ACHIVENETS" (
...
CREATE  OR REPLACE TABLE "TUTION_FEE_STRUCTURE" (
...
CREATE  OR REPLACE TABLE "TUTION_FEE_PAYMENT" (
...
CREATE  OR REPLACE TABLE "OTHER_FEE_STRUCTURE" (
...
CREATE  OR REPLACE TABLE "OTHER_FEE_PAYMENT" (
...
CREATE  OR REPLACE TABLE "DRIVER_DETAILS" (
...
CREATE  OR REPLACE TABLE "TRANSPORT_ROUT_DETAILS" (
...
CREATE  OR REPLACE TABLE "TRANSPORTATION_ALLOCATION" (
...
CREATE  OR REPLACE TABLE "LIBRARY_BOOK_CATEGORIES" (
...
CREATE  OR REPLACE TABLE "LIBRARY_BOOK_DETAILS" (
...
CREATE  OR REPLACE TABLE "LIBRARY_BOOK_ALLOCATION" (
