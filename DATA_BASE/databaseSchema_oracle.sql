...
CREATE TABLE "USER_ROLE" (
	...
	"USER_ROLE_NAME"   			VARCHAR2(18 BYTE) UNIQUE,
	"USER_ACCESS_AS_SCHOOL"		NUMBER(1,0) NOT NULL,
	"USER_ROLE_ACCESS"			CLOB,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_TIME"			VARCHAR2(20 BYTE),
	"MODIFIED_DATE_TIME"		VARCHAR2(20 BYTE),
...
CREATE TABLE "USER_DETAILS" (
	...
	"USER_QUALIFICATION"  		VARCHAR2(120 BYTE) NOT NULL,
	...
	FOREIGN KEY ("STAFF_ADDRESS_ID") REFERENCES "STAFF_ADDRESS" ("STAFF_ADDRESS_ID"),
	FOREIGN KEY ("APPOINTMENT_TYPE_ID") REFERENCES "STAFF_APPOINTMENT" ("APPOINTMENT_TYPE_ID"),
	CONSTRAINT "CK_INVALID_ATTEMPTS" CHECK (USER_GENDER IN ('0', '1', '2', '3')),
   	CONSTRAINT "CK_USER_GENDER" CHECK (USER_GENDER IN ('MALE', 'FEMALE')),	
	CONSTRAINT "CK_USER_STATUS" CHECK (USER_STATUS IN ('ACTIVE', 'INACTIVE'))	
)
/
CREATE TABLE "STAFF_LEAVES_STRUCTURE" (
	"STAFF_LEAVES_STRUCTURE_ID"		NUMBER(16,0) NOT NULL, 
	"APPOINTMENT_TYPE_ID"			NUMBER(16,0) NOT NULL,
    ...
    CONSTRAINT "PK_STAFF_LEAVES_STRUCTURE_ID" PRIMARY KEY ("STAFF_LEAVES_STRUCTURE_ID"),
    FOREIGN KEY ("APPOINTMENT_TYPE_ID") REFERENCES "STAFF_APPOINTMENT" ("APPOINTMENT_TYPE_ID")
)
/
CREATE TABLE "STAFF_LEAVES" (
    ...
    CONSTRAINT "PK_STAFFT_LEAVES_ID" PRIMARY KEY ("STAFFT_LEAVES_ID"),
	FOREIGN KEY ("STAFF_LEAVES_STRUCTURE_ID") REFERENCES "STAFF_LEAVES_STRUCTURE" ("STAFF_LEAVES_STRUCTURE_ID"),	
...
CREATE TABLE "SCHOOL_CLASS" (
	...
	"MIN_AGE_CRITERIA_IN_MONTHS"	NUMBER(3,0) NOT NULL,		
	"MAX_AGE_CRITERIA_IN_MONTHS"	NUMBER(3,0) NOT NULL,		
	"PERIODS_PER_DAY"     			NUMBER(2,0) NOT NULL,	
	"PERIOD_DURATION_IN_MINUTES"	NUMBER(3,0) NOT NULL,	
	"TEACHER_PERIODS_PER_DAY"		NUMBER(2,0),		
...
CREATE TABLE "CLASS_HOLIDAY_LIST" (
	...
	"SCHOOL_CLASS_ID"     		NUMBER(16,0) NOT NULL,
	"CLASS_HOLIDAY_FOR"  		VARCHAR2(30 BYTE)NULL,	
	"CLASS_HOLIDAY_FROM"			VARCHAR2(20 BYTE),		
	"CLASS_HOLIDAY_TO"			VARCHAR2(20 BYTE),	
	"NO_OF_DAYS"				NUMBER(2,0) DEFAULT 0 NOT NULL,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_TIME"			VARCHAR2(20 BYTE),
...
CREATE TABLE "TUITION_FEE_STRUCTURE" (
	"TUITION_FEE_STRUCTURE_ID"	NUMBER(16,0) NOT NULL,
	"SCHOOL_CLASS_ID"     		NUMBER(16,0) NOT NULL,	
	"AMOUNT_PER_INSTALMENT" 	NUMBER(15,2),
	"NUMBER_OF_INSTALMENTS"		NUMBER(2,0),
	"TOTAL_TUITION_FEE"			NUMBER(15,2) NOT NULL,		
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_TIME"			VARCHAR2(20 BYTE),
	"MODIFIED_DATE_TIME"		VARCHAR2(20 BYTE),
	
	CONSTRAINT "PK_TUITION_FEE_STRUCTURE_ID" PRIMARY KEY ("TUITION_FEE_STRUCTURE_ID"),
	FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "SCHOOL_CLASS" ("SCHOOL_CLASS_ID") 
)
/
CREATE TABLE "TUITION_FEE_PAYMENT" (
	"STUDNT_TUITIN_FEE_PYNT_ID"	VARCHAR2(18 BYTE) NOT NULL,
	"STUDENT_ROLL_NO"     		VARCHAR2(12 BYTE) NOT NULL,
	"TUITION_FEE_STRUCTURE_ID"	NUMBER(16,0) NOT NULL,
	"SCHOOL_CLASS_ID"     		NUMBER(16,0) NOT NULL,	
	"TUITION_FEE_PAID_RCPT_NO"	NUMBER(16,0) NOT NULL,
	"FEE_PAID"   				NUMBER(15,2) NOT NULL,
	"INSTALMENT_NUMBER"			NUMBER(2,0) NOT NULL,
	"BALANCE_TUITION_FEE"		NUMBER(15,2) NOT NULL,	
	...
	CONSTRAINT "PK_STUDNT_TUITIN_FEE_PYNT_ID" PRIMARY KEY ("STUDNT_TUITIN_FEE_PYNT_ID"),	 
	FOREIGN KEY ("TUITION_FEE_STRUCTURE_ID") REFERENCES "TUITION_FEE_STRUCTURE" ("TUITION_FEE_STRUCTURE_ID"),
	FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "SCHOOL_CLASS" ("SCHOOL_CLASS_ID") 
)
/
...
CREATE TABLE "VEHICLE_DETAILS" (
	...
	"VEHICLE_MAKE"					VARCHAR2(60 BYTE) NOT NULL,
	"VEHICLE_MODEL"					VARCHAR2(60 BYTE) NOT NULL,
	"VEHICLE_COLOUR"				VARCHAR2(60 BYTE),
	...
	"VEHICLE_CONDITION"				VARCHAR2(500 BYTE) NOT NULL,
	"VEHICLE_STATUS"				VARCHAR2(9 BYTE) NOT NULL,
	"CREATED_USER_ID"				VARCHAR2(12 BYTE),
	...
	CONSTRAINT "CK_VEHICLE_STATUS" CHECK (VEHICLE_STATUS IN ('ACTIVE', 'INACTIVE'))
)
/
CREATE TABLE "DRIVER_DETAILS" (
	...
	"DRIVER_INACTIVE_REASON"		VARCHAR2(300 BYTE),
	"DRIVER_INACTIVE_DATE_TIME"		VARCHAR2(20 BYTE),
	"APPOINTMENT_TYPE_ID"			UMBER(16,0) NOT NULL,
	"ADDRESS_LINE_1"			VARCHAR2(120 BYTE) NOT NULL,
	"TOWN_DISTRICT"				VARCHAR2(30 BYTE),
	"DISTRICT_CITY"				VARCHAR2(30 BYTE),
	"PINCODE"						NUMBER(6,0) NOT NULL,
...
CREATE TABLE "TRANSPORT_ROUT_DETAILS" (
	...
	"ROUT_NO"     				VARCHAR2(12 BYTE) UNIQUE,
	"ROUT_TYPE"					VARCHAR2(6, BYTE),
	"VEHICLE_REG_NO"			VARCHAR2(12 BYTE),	
	"STARTING_POINT"			VARCHAR2(60 BYTE) NOT NULL,
	"END_POINT"					VARCHAR2(60 BYTE) NOT NULL,
	"STOPS"						VARCHAR2(500, BYTE),
	"TOTAL_STOPS"				NUMBER(3,0) NOT NULL,		
	"STARTING_TIME"				VARCHAR2(20 BYTE),
	"REACHING_TIME"				VARCHAR2(20 BYTE),
	"TOTAL_SEATES"				VARCHAR2(12 BYTE)  NOT NULL,
	"SEATES_LEFT"				VARCHAR2(12 BYTE)  NOT NULL,	
	"ROUT_STATUS"				VARCHAR2(8 BYTE) NOT NULL,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"ROUT_INACTIVE_REASON"		VARCHAR2(300 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_TIME"			VARCHAR2(20 BYTE),
	"MODIFIED_DATE_TIME"		VARCHAR2(20 BYTE),
	
	CONSTRAINT "PK_TRANSPORTATION_ID" PRIMARY KEY ("TRANSPORTATION_ID"),
	CONSTRAINT "CK_ROUT_TYPE" CHECK (ROUT_TYPE IN ('PICKUP', 'DROP')),
	CONSTRAINT "CK_ROUT_STATUS" CHECK (ROUT_STATUS IN ('ACTIVE', 'INACTIVE')),
