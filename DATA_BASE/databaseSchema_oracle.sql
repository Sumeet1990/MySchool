...
CREATE TABLE "USER_DETAILS" (
	...
	"INVALID_ATTEMPTS"			NUMBER(1,0) DEFAULT 0,
	"STAFF_ID"     				NUMBER(16,0) NOT NULL,
...
CREATE TABLE "SCHOOL_TIMINGS" (
	...
	CONSTRAINT "SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "SCHOOL_CLASS" ("SCHOOL_CLASS_ID"),
...
CREATE TABLE "GENERAL_HOLIDAY_LIST" (
	...
	"NO_OF_DAYS"				NUMBER(2,0) NOT NULL,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2(20 BYTE),
...
CREATE TABLE "STUDENT_ATTENDANCE" (
	...
	CONSTRAINT "CLASS_SECTION_ID" FOREIGN KEY ("CLASS_SECTION_ID") REFERENCES "CLASS_SECTION" ("CLASS_SECTION_ID"),
...
CREATE TABLE "STUDENT_REPORT" (
	...
	"TOTAL_LEAVE_DAYS"			NUMBER(3,0) NOT NULL,
	"TOTAL_ABSENT_DAYS"			NUMBER(3,0) NOT NULL,
...
CREATE TABLE "TRANSPORT_ALLOCATION" (
	"TRANSPORT_ALLOC_ID"	NUMBER(16,0) NOT NULL,	
	"STUDENT_ROLL_NO"     			NUMBER(16,0),	
	"STAFF_ID" 		    			NUMBER(16,0),			
	"ROUT_NO"     					VARCHAR2(12 BYTE) NOT NULL,	
	...
	CONSTRAINT "PK_TRANSPORT_ALLOC_ID" PRIMARY KEY ("TRANSPORT_ALLOC_ID"),	 
	FOREIGN KEY ("STAFF_ID") REFERENCES "STAFF_DETAILS" ("STAFF_ID") 	
)
