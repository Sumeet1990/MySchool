...
/
CREATE TABLE "STAFFT_LEAVES" (
	"STAFFT_LEAVES_ID"	 		BIGINT NOT NULL, 
	"STAFF_ID"     				BIGINT NOT NULL,	
	"STAFF_LEAVES_STRUCTURE_ID"	BIGINT NOT NULL, 		
...
CREATE TABLE "TUITION_FEE_STRUCTURE" (
	"TUITION_FEE_STRUCTURE_ID"	BIGINT NOT NULL,
	"SCHOOL_CLASS_ID"     		BIGINT NOT NULL,	
	"AMOUNT_PER_INSTALMENT" 	DECIMAL(15,2),
	"NUMBER_OF_INSTALMENTS"		TINYINT,
	"TOTAL_TUITION_FEE"			DECIMAL(15,2) NOT NULL,		
	"CREATED_USER_ID"			VARCHAR(12),
	"MODIFIED_USER_ID"			VARCHAR(12),
	"CREATED_DATE_TIME"			VARCHAR(20),
	"MODIFIED_DATE_TIME"		VARCHAR(20),
...
CREATE TABLE "TUITION_FEE_PAYMENT" (
	...
	"TUITION_FEE_STRUCTURE_ID"	BIGINT NOT NULL,
	"SCHOOL_CLASS_ID"     		BIGINT NOT NULL,	
	"TUITION_FEE_PAID_RCPT_NO"	BIGINT NOT NULL,
	"FEE_PAID"   				DECIMAL(15,2) NOT NULL,
	"INSTALMENT_NUMBER"			TINYINT NOT NULL,
	"BALANCE_TUITION_FEE"		DECIMAL(15,2) NOT NULL,	
