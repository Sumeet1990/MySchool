CREATE OR REPLACE TABLE "MYSCHOOL"."STAFF_ADDRESS" (
	...
	"CREATED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2(20 BYTE),
	
	CONSTRAINT "PK_STAFF_ADDRESS_ID" PRIMARY KEY ("STAFF_ADDRESS_ID")
)

CREATE OR REPLACE TABLE "MYSCHOOL"."USER_DETAILS" (
	...
	"INVALID_ATTEMPTS"			NUMBER(1,0) NOT NULL DEFAULT 0,
	"STAFF_ID"     				NUMBER(16,0) NOT NULL,
	"FORGOT_PASSWORD_QUESTION"	VARCHAR2(90 BYTE) NOT NULL,
	...
	CONSTRAINT "FK_STAFF_ID" FOREIGN KEY ("STAFF_ID") REFERENCES "MYSCHOOL"."STAFF_ADDRESS" ("STAFF_ID") ENABLE,
	CONSTRAINT "CK_USER_STATUS" CHECK (USER_STATUS IN ('ACTIVE', 'NOT_ACTIVE')) ENABLE,
	CONSTRAINT "CK_IS_USER_TESCHING_STAFF" CHECK (IS_USER_TESCHING_STAFF IN ('YES', 'NO')) ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."STAFF_APPOINTMENT" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."STAFF_DETAILS" (
	"STAFF_ID"     				NUMBER(16,0) NOT NULL,
	"STAFF_REGISTRATION_ID" 	NUMBER(16,0) NOT NULL UNIQUE,
	...
	"CLASS_TEACHER_FLAG"		VARCHAR2(3 BYTE) NOT NULL DEFAULT NO,
	"SUBJECT_CODES"				VARCHAR2(3 BYTE),
	...
	CONSTRAINT "CK_STAFF_GENDER" CHECK (STAFF_GENDER IN ('MALE', 'FEMALE')) ENABLE,
	CONSTRAINT "CK_STAFF_STATUS" CHECK (STAFF_STATUS IN ('ACTIVE', 'INACTIVE')) ENABLE,
	CONSTRAINT "CK_TEACHER_STAFF_FLAG" CHECK (TEACHER_STAFF_FLAG IN ('YES', 'NO')) ENABLE,
	CONSTRAINT "CK_CLASS_TEACHER_FLAG" CHECK (CLASS_TEACHER_FLAG IN ('YES', 'NO')) ENABLE	
)

CREATE OR REPLACE TABLE "MYSCHOOL"."STAFF_LEAVES" (
    ...
    CONSTRAINT "PK_STAFF_LEAVES_ID" PRIMARY KEY ("STAFF_LEAVES_ID")   
)

CREATE OR REPLACE TABLE "MYSCHOOL"."STAFF_ATTENDANCE" (
	"STAFF_ATTENDANCE_ID"	 	NUMBER(16,0) NOT NULL, 
	"STAFF_ID		"     		VARCHAR2(12 BYTE) NOT NULL,	
	"STAFFT_LEAVES_ID" 			NUMBER(16,0) NOT NULL, 	
	"SCHOOL_STAFF_LEAVE_ID" 	NUMBER(16,0) NOT NULL,	
	"REASON"		     		VARCHAR2(30 BYTE),
	"LEAVE_FROM"				VARCHAR2(12 BYTE),
	"LEAVE_TO		"			VARCHAR2(12 BYTE),
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2(20 BYTE),
	
    CONSTRAINT "PK_STAFF_ATTENDANCE_ID" PRIMARY KEY ("STAFF_ATTENDANCE_ID"),
	CONSTRAINT "FK_STAFFT_LEAVES_ID" FOREIGN KEY ("STAFFT_LEAVES_ID") REFERENCES "MYSCHOOL"."STAFF_LEAVES" ("STAFFT_LEAVES_ID") ENABLE,	
    CONSTRAINT "FK_STAFF_ID" FOREIGN KEY ("STAFF_ID") REFERENCES "MYSCHOOL"."STAFF_DETAILS" ("STAFF_ID") ENABLE,	
	CONSTRAINT "FK_STAFF_ID" FOREIGN KEY ("STAFF_ID") REFERENCES "MYSCHOOL"."STAFF_DETAILS" ("STAFF_ID") ENABLE	
)

CREATE OR REPLACE TABLE "MYSCHOOL"."SCHOOL_CLASS" (
	...
	CONSTRAINT "CK_CLASS_STATUS" CHECK (CLASS_STATUS IN ('ACTIVE', 'INACTIVE')) ENABLE	
)

CREATE OR REPLACE TABLE "MYSCHOOL"."CLASS_SECTION" (
	...
	"SECTION_STATUS"			VARCHAR2(8, BYTE),
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2(20 BYTE),
    ...
    CONSTRAINT "FK_SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "MYSCHOOL"."SCHOOL_CLASS" ("SCHOOL_CLASS_ID") ENABLE,
    CONSTRAINT "FK_STAFF_ID" FOREIGN KEY ("STAFF_ID") REFERENCES "MYSCHOOL"."STAFF" ("STAFF_ID") ENABLE,
	CONSTRAINT "CK_SECTION_STATUS" CHECK (SECTION_STATUS IN ('ACTIVE', 'INACTIVE')) ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."SCHOOL_TIMINGS" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."SUBJECT_CODES" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."TEACHING_STAFF" (
	"TEACHING_STAFF_ID" 			NUMBER(16,0) NOT NULL, 	
	"STAFF_ID"	     				NUMBER(16,0) NOT NULL,		
	"SUBJECT_CODES"					VARCHAR2(100 BYTE) NOT NULL,	
	"CREATED_USER_ID"				VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"				VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"			VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
...
CREATE OR REPLACE TABLE "MYSCHOOL"."CLASS_EXAMS" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."EXAM_SUBJECT_SCHEDULE" (
	...
	CONSTRAINT "PK_EXAM_SUBJECT_SCHEDULE_ID" PRIMARY KEY ("EXAM_SUBJECT_SCHEDULE"),
	CONSTRAINT "FK_SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "MYSCHOOL"."SCHOOL_CLASS" ("SCHOOL_CLASS_ID") ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."GENERAL_HOLIDAY_LIST" (
	...
	"NO_OF_DAYS"				NUMBER(2,0) NOT NULL DEFAULT 0,
	"CREATED_USER_ID"			VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"			VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"	VARCHAR2(20 BYTE),
...
CREATE OR REPLACE TABLE "MYSCHOOL"."CLASS_HOLIDAY_LIST" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."GENERAL_EVENTS" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."CLASS_EVENTS" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."STUDENT_REGISTRATION_DETAILS" (
	"STUDENT_REG_DETAILS_ID" 	NUMBER(16,0) NOT NULL, 
	"STUDENT_REGISTRATION_ID" 	NUMBER(16,0) NOT NULL UNIQUE, 	
	...
	CONSTRAINT "CK_TRANSPORT_REQUIRED" CHECK (STUDENT_STATUS IN ('NO', 'PICKUP', 'DROP', 'BOTH')) ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."STUDENT_CURRENT_DETAILS" (
	...
	"CLASS_SECTION_ID" 				NUMBER(16,0) NOT NULL,
	"FINAL_EXAM_RESULT" 			VARCHAR2(8,BYTE),		
	"CREATED_USER_ID"				VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"				VARCHAR2(12 BYTE),
	"CREATED_DATE_AND_TIME"			VARCHAR2(20 BYTE),
	"MODIFIED_DATE_AND_TIME"		VARCHAR2(20 BYTE),
    ...
    CONSTRAINT "FK_STUDENT_REGISTRATION_ID" FOREIGN KEY ("STUDENT_REGISTRATION_ID") REFERENCES "MYSCHOOL"."STUDENT_REGISTRATION_DETAILS" ("STUDENT_REGISTRATION_ID") ENABLE,
	CONSTRAINT "CK_FINAL_EXAM_RESULT" CHECK (FINAL_EXAM_RESULT IN ('PROMOTED', 'FAILED')) ENABLE
	
)

CREATE OR REPLACE TABLE "MYSCHOOL"."STUDENT_ADDRESS" (
	"STUDENT_ADDRESS_ID"   		NUMBER(16,0) NOT NULL,
...
CREATE OR REPLACE TABLE "MYSCHOOL"."STUDENT_LEAVES" (
	"STUDENT_LEAVES_ID" 			NUMBER(16,0) NOT NULL, 	
	"STUDENT_LEAVE_TYPE"	     	VARCHAR2(30 BYTE) NOT NULL,			
	"MAX_LEAVE_DAYS"				NUMBER(3,0) NOT NULL,
	"MAX_CONSECUTIVE_LEAVE_DAYS"	VARCHAR2(12 BYTE),
	"CREATED_USER_ID"				VARCHAR2(12 BYTE),
	"MODIFIED_USER_ID"				VARCHAR2(12 BYTE),
...
CREATE OR REPLACE TABLE "MYSCHOOL"."STUDENT_ATTENDANCE" (
	...
	CONSTRAINT "FK_STUDENT_LEAVES_ID" FOREIGN KEY ("STUDENT_LEAVES_ID") REFERENCES "MYSCHOOL"."STUDENT_LEAVES" ("STUDENT_LEAVES_ID") ENABLE,
    CONSTRAINT "FK_STUDENT_ROLL_NO" FOREIGN KEY ("STUDENT_ROLL_NO") REFERENCES "MYSCHOOL"."STUDENT_CURRENT_DETAILS" ("STUDENT_ROLL_NO") ENABLE,
	CONSTRAINT "FK_SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "MYSCHOOL"."SCHOOL_CLASS" ("SCHOOL_CLASS_ID") ENABLE		
)

CREATE OR REPLACE TABLE "MYSCHOOL"."STUDENT_REPORT" (
	...
	"SUBJECT_CODES_MARKS"		VARCHAR2(600 BYTE) NOT NULL,	
	"SUBJECTS_FAILED"			NUMBER(2,0) NOT NULL,
	"TOTAL_MARKS"				NUMBER(6,2) NOT NULL,
	...
	CONSTRAINT "CK_EXAM_RESULT" CHECK (EXAM_RESULT IN ('PASS', 'FAIL')) ENABLE		
)

CREATE OR REPLACE TABLE "MYSCHOOL"."SCHOOL_ACHIVENETS" (
	"SCHOOL_ACHIVENETS_ID"		NUMBER(16,0) NOT NULL,
	"EVENT"     				VARCHAR2(120,0) NOT NULL,
	"ACHIEVEMENT_FOR"			VARCHAR2(120,0) NOT NULL,	
	"STAFF_ID" 					NUMBER(16,0),
	"STUDENT_ROLL_NUMBER"		NUMBER(16,0),
	...
	CONSTRAINT "FK_STAFF_ID" FOREIGN KEY ("STAFF_ID") REFERENCES "MYSCHOOL"."STAFF_DETAILS" ("STAFF_ID") ENABLE,
	CONSTRAINT "FK_STUDENT_ROLL_NUMBER" FOREIGN KEY ("STUDENT_ROLL_NUMBER") REFERENCES "MYSCHOOL"."STUDENT_CURRENT_DETAILS" ("STUDENT_ROLL_NUMBER") ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."TUTION_FEE_STRUCTURE" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."TUTION_FEE_PAYMENT" (
	...
	CONSTRAINT "FK_STUDENT_ROLL_NO" FOREIGN KEY ("STUDENT_ROLL_NO") REFERENCES "MYSCHOOL"."STUDENT_CURRENT_DETAILS" ("STUDENT_ROLL_NO") ENABLE,
	CONSTRAINT "FK_TUTION_FEE_STRUCTURE_ID" FOREIGN KEY ("TUTION_FEE_STRUCTURE_ID") REFERENCES "MYSCHOOL"."TUTION_FEE_STRUCTURE" ("TUTION_FEE_STRUCTURE_ID") ENABLE,
	CONSTRAINT "FK_SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "MYSCHOOL"."SCHOOL_CLASS" ("SCHOOL_CLASS_ID") ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."OTHER_FEE_STRUCTURE" (
	"OTHER_FEE_STRUCTURE_ID"	NUMBER(16,0) NOT NULL,
	"SCHOOL_CLASS_ID"     		NUMBER(16,0) NOT NULL,	
	"OTHER_FEE_NAME"   			VARCHAR2(60 BYTE) UNIQUE,
...
CREATE OR REPLACE TABLE "MYSCHOOL"."OTHER_FEE_PAYMENT" (
	...
	CONSTRAINT "FK_STUDENT_ROLL_NO" FOREIGN KEY ("STUDENT_ROLL_NO") REFERENCES "MYSCHOOL"."STUDENT_CURRENT_DETAILS" ("STUDENT_ROLL_NO") ENABLE,
	CONSTRAINT "FK_OTHER_FEE_STRUCTURE_ID" FOREIGN KEY ("OTHER_FEE_STRUCTURE_ID") REFERENCES "MYSCHOOL"."OTHER_FEE_STRUCTURE" ("OTHER_FEE_STRUCTURE_ID") ENABLE,
	CONSTRAINT "FK_SCHOOL_CLASS_ID" FOREIGN KEY ("SCHOOL_CLASS_ID") REFERENCES "MYSCHOOL"."SCHOOL_CLASS" ("SCHOOL_CLASS_ID") ENABLE
)
	
CREATE OR REPLACE TABLE "MYSCHOOL"."VEHICLE_DETAILS" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."DRIVER_DETAILS" (
	...
	CONSTRAINT "PK_DRIVER_DETAILS_ID" PRIMARY KEY ("DRIVER_DETAILS"),	
	CONSTRAINT "CK_DRIVER_GENDER" CHECK (DRIVER_GENDER IN ('MALE', 'FEMALE')) ENABLE,
	CONSTRAINT "CK_DRIVER_STATUS" CHECK (DRIVER_STATUS IN ('ACTIVE', 'INACTIVE')) ENABLE,
)

CREATE OR REPLACE TABLE "MYSCHOOL"."TRANSPORT_ROUT_DETAILS" (
	...
	CONSTRAINT "PK_TRANSPORTATION_ID" PRIMARY KEY ("TRANSPORTATION"),
	CONSTRAINT "FK_VEHICLE_REG_NO" FOREIGN KEY ("VEHICLE_REG_NO") REFERENCES "MYSCHOOL"."VEHICLE_DETAILS" ("VEHICLE_REG_NO") ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."TRANSPORTATION_ALLOCATION" (
	...
	CONSTRAINT "PK_TRANSPORTATION_ALLOCATION_ID" PRIMARY KEY ("TRANSPORTATION_ALLOCATION"),
	CONSTRAINT "FK_STUDENT_ROLL_NO" FOREIGN KEY ("STUDENT_ROLL_NO") REFERENCES "MYSCHOOL"."STUDENT_CURRENT_DETAILS" ("STUDENT_ROLL_NO") ENABLE,
	CONSTRAINT "FK_STAFF_ID" FOREIGN KEY ("STAFF_ID") REFERENCES "MYSCHOOL"."STAFF_DETAILS" ("STAFF_ID") ENABLE,
	CONSTRAINT "FK_ROUT_NO" FOREIGN KEY ("ROUT_NO") REFERENCES "MYSCHOOL"."TRANSPORT_ROUT_DETAILS" ("ROUT_NO") ENABLE	
)

CREATE OR REPLACE TABLE "MYSCHOOL"."LIBRARY_BOOK_CATEGORIES" (
...
CREATE OR REPLACE TABLE "MYSCHOOL"."LIBRARY_BOOK_DETAILS" (
	...
	"BOOK_PRICE"	  				VARCHAR2(12 BYTE) NOT NULL,	
	...
	CONSTRAINT "FK_BOOK_CATEGORY_ID" FOREIGN KEY ("BOOK_CATEGORY_ID") REFERENCES "MYSCHOOL"."LIBRARY_BOOK_CATEGORIES" ("BOOK_CATEGORY_ID") ENABLE
)

CREATE OR REPLACE TABLE "MYSCHOOL"."LIBRARY_BOOK_ALLOCATION" (
	"TRANSPORTATION_ALLOCATION_ID"	NUMBER(16,0) NOT NULL,	
	"STUDENT_ROLL_NO"     			NUMBER(16,0),	
	"STAFF_ID" 		    			NUMBER(16,0),	
	"BOOK_CODE"		     			VARCHAR2(30 BYTE) NOT NULL,	
	"BOOK_ALLOCATED_DATE"			VARCHAR2(20 BYTE)  NOT NULL,
