...
<body>
<h1 class="textColor" align="center" style="margin-top: 0; "><s:property value="getText('global.schoolname')"/></h1>
...
<s:a style="color:aliceblue;" href="%{helpAction}" > <img id="Icon" style="  right:60px" src="images/Help and support.png" onmouseout="hideToolTip()" onmouseover="showToolTip('Help','60px')"></s:a>  
<s:a style="color:aliceblue;" href="%{logoutAction}" > <img id="Icon" style=" right:10px" src="images/gnome-session-logout.png" onmouseout="hideToolTip()" onmouseover="showToolTip('Logout','10px')"></s:a>
</body>
