	...
	<body>
		<div class="wrap">
			<ul id="menu-category-menu" class="menu genesis-nav-menu menu-secondary">
				<s:if test="schoolAccess.functionalManagement.fmAdministrator.fmAdministratorAccess">
		...
		<br/><h5 align="left">Click on the above Menu to load the required sub-menu's</h5>
		<s:form  method="POST">
			<s:if test="schoolAccess.functionalManagement.fmAdministrator.fmAdministratorAccess">	
				<div class="sTop" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.administrator')"/></h2>
						<div id="slide">
							<br/>
			...
			<s:if test="schoolAccess.functionalManagement.fmLeaves.fmLeavesAccess">
				<div class="s1" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.leaves')"/></h2>
						<div id="slide">
							<br/>
							<div style="clear:both"></div>
			...
			<s:if test="schoolAccess.functionalManagement.fmCommunication.fmCommunicationAccess">
				<div class="s2" style="display: none">
					<div class="inner">
					<br/>
						<h2 align="center"><s:property value="getText('fm.communication')"/></h2>
						<div id="slide">
							<br/>
							<div style="clear:both"></div>
			...
			<s:if test="schoolAccess.functionalManagement.fmTransportation.fmTransportationAccess">
				<div class="s3" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.transportation')"/></h2>
						<div id="slide">
							<br/>
							<div style="clear:both"></div>
			...
			<s:if test="schoolAccess.functionalManagement.fmFinance.fmFinanceAccess">
				<div class="s4" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.finance')"/></h2>
						<div id="slide">
							<br/>
							<div style="clear:both"></div>
			...
			<s:if test="schoolAccess.functionalManagement.fmLibrary.fmLibraryAccess">
				<div class="s5" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.library')"/></h2>
						<div id="slide">
							<br/>
							<div style="clear:both"></div>
			...
			<s:if test="schoolAccess.functionalManagement.fmReports.fmReportsAccess">
				<div class="s6" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.reports')"/></h2>
							<div id="slide">
							<br/>
							<div style="clear:both"></div>
			...
			<s:if test="schoolAccess.functionalManagement.fmAvailability.fmAvailabilityAccess">
				<div class="s7" style="display: none">
					<div class="inner">
						<h2 align="center"><s:property value="getText('fm.availability')"/></h2>
						<div id="slide">
							<br/>
							<div style="clear:both"></div>
