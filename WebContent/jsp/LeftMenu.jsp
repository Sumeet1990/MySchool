...
<html>
	...
	<body>		
		<div id="accordian">
			<ul>
				<li >
					<h3 id="cm" onclick="manageDivForMenu('configurationalContent')"><span class="icon-dashboard"></span><s:property value="getText('leftmenu.configurationmanagement')"/></h3>
					<ul id="1">
				...
				<li>
					<h3 id="fm"  onclick="manageDivForMenu('functionalContent')"><span class="icon-tasks"></span><s:property value="getText('leftmenu.functionalmanagement')"/></h3>
					<ul id="2">
